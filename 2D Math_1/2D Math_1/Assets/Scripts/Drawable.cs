...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        public bool isPenMode;      // ÀÌ ½ºÅ©¸³Æ® Ææ¸ðµå´Â Ææ ³ª¿È ¿©ºÎ

        public GameObject RedPenOn;
        public GameObject RedPenOff;
        public GameObject BluePenOn;
        public GameObject BluePenOff;
        public GameObject GreenPenOn;
        public GameObject GreenPenOff;
        public GameObject PinkPenOn;
        public GameObject PinkPenOff;
        public GameObject OrangePenOn;
        public GameObject OrangePenOff;
        public GameObject CyanPenOn;
        public GameObject CyanPenOff;
        public GameObject BrownPenOn;
        public GameObject BrownPenOff;
        public GameObject YellowPenOn;
        public GameObject YellowPenOff;
        public GameObject EraserPenOn;
        public GameObject EraserPenOff;
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
                ...
                if (mouse_held_down && !no_drawing_on_current_drag  &&isPenMode==true  )
                {
        ...
        public void EraserPenOnBt()
        {
            isPenMode = true;

            EraserPenOn.SetActive(true);
            RedPenOff.SetActive(true);
            BluePenOff.SetActive(true);
            GreenPenOff.SetActive(true);
            YellowPenOff.SetActive(true);
            CyanPenOff.SetActive(true);
            BrownPenOff.SetActive(true);
            OrangePenOff.SetActive(true);
            PinkPenOff.SetActive(true);
            

            EraserPenOff.SetActive(false);
            RedPenOn.SetActive(false);
            GreenPenOn.SetActive(false);
            BluePenOn.SetActive(false);
            YellowPenOn.SetActive(false);
            PinkPenOn.SetActive(false);
